# Generated by Django 4.2.6 on 2024-03-08 12:51
...
import tasks.models.voicecomment
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('soundfile', models.FileField(storage=task_manager.storage_backends.MediaStorage(), upload_to=tasks.models.voicecomment.user_directory_path)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='soundfile', to=settings.AUTH_USER_MODEL)),
