...
class TestViewer(unittest.TestCase):
    ...
    def test_side_bar_button_should_display_the_view_accordingly(self):
        ...
        bookmark_view = self.driver.find_element(*MainPageLocators.BOOKMARK_VIEW)
        ...
        self.assertEqual(bookmark_view.value_of_css_property("display"), 'none')
        ...
        self.assertEqual(outline_view.value_of_css_property("display"), 'none')
        self.assertEqual(comment_view.value_of_css_property("display"), 'none')
        self.assertEqual(bookmark_view.value_of_css_property("display"), 'block')
